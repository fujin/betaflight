...
static uint16_t gyroConfig_gyro_stage1_soft_lpf_hz;
static uint8_t gyroConfig_gyro_stage2_soft_lpf_hz;
...
{
    gyroConfig_gyro_stage1_soft_lpf_hz =  gyroConfig()->gyro_stage1_soft_lpf_hz;
    gyroConfig_gyro_stage2_soft_lpf_hz =  gyroConfig()->gyro_stage2_soft_lpf_hz;
...
static long cmsx_menuGyro_onExit(const OSD_Entry *self)
{
    ...
    gyroConfigMutable()->gyro_stage1_soft_lpf_hz =  gyroConfig_gyro_stage1_soft_lpf_hz;
    gyroConfigMutable()->gyro_stage2_soft_lpf_hz =  gyroConfig_gyro_stage2_soft_lpf_hz;
...
static OSD_Entry cmsx_menuFilterGlobalEntries[] =
{
    ...
    { "GYRO LPF1",  OME_UINT16, NULL, &(OSD_UINT16_t) { &gyroConfig_gyro_stage1_soft_lpf_hz, 0, 16000, 1 }, 0 },
    { "GYRO LPF2",  OME_UINT8,  NULL, &(OSD_UINT8_t)  { &gyroConfig_gyro_stage2_soft_lpf_hz,  0, 255, 1 }, 0 },
