...
static bool blackboxWriteSysinfo(void)
{
    ...
    switch (xmitState.headerIndex) {
        ...
        BLACKBOX_PRINT_HEADER_LINE("gyro_stage1_lowpass_type", "%d",        gyroConfig()->gyro_stage1_soft_lpf_type);
        BLACKBOX_PRINT_HEADER_LINE("gyro_stage2_lowpass_type", "%d",        gyroConfig()->gyro_stage2_soft_lpf_type);
        BLACKBOX_PRINT_HEADER_LINE("gyro_stage1_lowpass_hz", "%d",          gyroConfig()->gyro_stage1_soft_lpf_hz);
        BLACKBOX_PRINT_HEADER_LINE("gyro_stage2_lowpass_hz", "%d",          gyroConfig()->gyro_stage2_soft_lpf_hz);
